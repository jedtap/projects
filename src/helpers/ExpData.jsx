...
import Proj from '../icons/proj.svg';
...
import Resource from '../icons/group.svg';
import Sdk from '../icons/sdk.svg';


const ExpData = [
  { key: 301, name: 'Research', img: Research, alt: 'icon of an erlenmeyer flask' },
  { key: 302, name: 'Project Management', img: Proj, alt: 'icon of a folder' },
  { key: 303, name: 'Portfolio Management', img: Portfolio, alt: 'icon of two folders' },
  { key: 304, name: 'Financial Management', img: Financial, alt: 'icon of a dollar sign inside a circle' },
